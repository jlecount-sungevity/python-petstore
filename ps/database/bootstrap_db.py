...
con.execute("CREATE TABLE pet( id INTEGER PRIMARY KEY, name char(100) NOT NULL, added_at DATETIME, added_by INTEGER, pet_type char(100) NOT NULL, pet_status_id INTEGER, cost INTEGER, FOREIGN KEY(pet_status_id) REFERENCES pet_status(id), FOREIGN KEY(added_by) REFERENCES user(id))")
...
con.execute("INSERT into user(role, username, password, bank_account_balance_dollars, status) values (?, ?, ?, ?, ?)",  ("admin", "jlecount@sungevity.com", "somepass", 0, "1"));
con.execute("INSERT into user(role, username, password, bank_account_balance_dollars, status) values (?, ?, ?, ?, ?)",  ("admin", "gsandhu@sungevity.com", "sungevity", 0, "1"));
con.execute("INSERT into user(role, username, password, bank_account_balance_dollars, status) values (?, ?, ?, ?, ?)",  ("admin", "mbrewer@sungevity.com", "somepass", 0, "1"));
con.execute("INSERT into user(role, username, password, bank_account_balance_dollars, status) values (?, ?, ?, ?, ?)",  ("admin", "kgavar@sungevity.com", "somepass", 0, "1"));
con.execute("INSERT into user(role, username, password, bank_account_balance_dollars, status) values (?, ?, ?, ?, ?)",  ("admin", "bgordon@sungevity.com", "somepass", 0, "1"));
con.execute("INSERT into user(role, username, password, bank_account_balance_dollars, status) values (?, ?, ?, ?, ?)",  ("admin", "hkhan@sungevity.com", "sungevity", 0, "1"));
con.execute("INSERT into user(role, username, password, bank_account_balance_dollars, status) values (?, ?, ?, ?, ?)",  ("admin", "efattig@sungevity.com", "sungevity", 0, "1"));
